...
from PyQt6.QtGui import QColor, QDesktopServices, QIcon, QKeySequence, QPainter, QPixmap, QShortcut, QTextDocument
...
from krok_helper.updater.dialogs import UpdateSourceOrderDialog, WorkbenchUpdateDialog
...
class KrokHelperQtApp(AlignmentPageMixin, HiResPageMixin, LyricsSearchPageMixin, QMainWindow):
    """工作台主窗口（外壳）。

    波形对齐、Hi-Res 混流、歌词检索三页分别住在
    :class:`~krok_helper.alignment.page.AlignmentPageMixin`、
    :class:`~krok_helper.hires.page.HiResPageMixin` 和
    :class:`~krok_helper.lyrics_search.page.LyricsSearchPageMixin`，混进来共用
